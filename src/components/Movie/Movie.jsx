...
const Movie = ({ movie, index }) => {
  return (
    <div className=' h-auto w-[250px] flex justify-start items-center flex-col text-white'>
      <Link to={`/movie/${movie?.id}`}>
        <div className=" w-[250px] rounded-2xl overflow-hidden ">
          <img src={movie.poster_path ? `http://image.tmdb.org/t/p/w500/${movie.poster_path}` : "https://www.fillmurray.com/200/300"}
            alt={movie?.title}
            className='w-full' />
